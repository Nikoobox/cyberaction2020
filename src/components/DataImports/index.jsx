...
export const BDAY_DATA = [
  ...
  ["Будни:", "12000 руб/10 чел. за 2,5 часа"],
  ["Выходные:", "16000 руб/10 чел. за 2,5 часа"],
];
...
export const BDAY_DATA_EXTRA = [
  ...
  ["Будний день:", "500 руб/чел/2,5 часа"],
  ["Выходной:", "700 руб/чел/2,5 часа"],
];
...
export const BDAY_DATA_INCLUDED = [
  ...
  [
    "Дополнительно предолагаем услуги фотографа на все время мероаприятия. Стоимость: 3000 руб.",
  ],
];
